export class Input {
  ...
  pos(e) { const r = this.game.canvas.getBoundingClientRect(); return this.game.camera.screenToWorld((e.clientX - r.left) * this.game.canvas.width / r.width, (e.clientY - r.top) * this.game.canvas.height / r.height); }
